<?php
  ...
  write_head_open();
  write_head_metadata("SDL Blit Speed Comparison",
		      "Page with statistics for the blit speed of SDL under different conditions");
...
<div id="content">
<div class="containclear">
<h2><abbr title="Simple Directmedia Layer">SDL</abbr> Blit-speed Comparison</h2>
...
<a href="http://microsoft.com/directx">Microsoft DirectX&reg;</a> on Microsoft 
Windows&reg; platforms.&nbsp; There were no unexpected visual effects
...
<p>The WinDIB video backend provides graphics support for Microsoft Windows&reg;
platforms using
<a href="http://msdn2.microsoft.com/en-us/library/ms536795.aspx">Windows&reg;
