...
module Jekyll
  ...
  # Any file names (or patterns) to exclude from the generated sitemap.xml
  EXCLUDED_FILES = ["KevinLocke.vcf", /^\d{3}\.x?html$/, /\.asc$/, /\.pem$/]

  # Any files that include posts, so that when a new post is added, the last
  # modified date of these pages should take that into account
  PAGES_INCLUDE_POSTS = ["bits/index.xhtml"]
